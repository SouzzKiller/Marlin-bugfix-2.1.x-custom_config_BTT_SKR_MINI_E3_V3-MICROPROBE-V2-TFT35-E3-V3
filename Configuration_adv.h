...
#define CONTROLLER_FAN_PIN PB15
  ...
  //#define CONTROLLER_FAN2_PIN PB15          // Set a custom pin for second controller fan
  ...
  //#define CONTROLLER_FAN_MIN_BOARD_TEMP 40  // (°C) T urn on the fan if the board reaches this temperature
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT_HOME  (X_CURRENT  * (73 / 100))  // (mA) RMS current for homing. (Typically lower than *_CURRENT.)
    ...
    #define Y_CURRENT_HOME  (Y_CURRENT *(73 / 100))
    ...
    #define Z_CURRENT_HOME  (Z_CURRENT * (73 / 100))
