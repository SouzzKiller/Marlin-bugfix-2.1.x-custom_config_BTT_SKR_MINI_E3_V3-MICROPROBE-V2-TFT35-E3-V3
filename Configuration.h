...
#define STRING_CONFIG_H_AUTHOR "(SouzzKiller)" // Original author or contributor.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 42, -0.40, 0 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
